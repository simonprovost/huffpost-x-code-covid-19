...
## mv [name_fichier_BEFORE] [name_fichier_AFTER] // mv -> move.
...
## Need to add this line if ever you have a new CSV IN CHARGE:
### sudo mv /home/ubuntu/huffpost-x-code-covid-19/[NAME_OF_YOUR_CSV].csv /var/www/html
